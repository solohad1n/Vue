<template>
  <div class="cart__item">
    ...
    <div @click="handleClickRemove" class="cart__item-remove">
...
export default {
  ...
  setup(props) {
    ...
    const handleClickMinus = () => {
      store.commit("DECREMENT_CART_ITEM",props.item.id);
    };
    const handleClickPlus = () => {
      store.commit("INCREMENT_CART_ITEM",props.item.id);
    };
    const handleClickRemove = () => {
      store.commit("REMOVE_CART_ITEM",props.item.id);
    };
