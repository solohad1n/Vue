        ...
        <div class="cart">
          <div class="cart__top">
            <h2 class="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
              ...
              Корзина</h2>
            <div @click="handleDeleteAllPizzas" class="cart__clear">
          ...
          <div class="cart__bottom">
            <div class="cart__bottom-details">
              <span> Всего пицц: <b>{{totalCount? totalCount : 0}} шт.</b> </span>
              <span> Сумма заказа: <b>{{totalSum ? totalSum : 0}} ₽</b> </span>
            </div>
...
export default {
    components: {CartItem,CartIsEmpty,Header},
    setup() {
        ...
        const handleDeleteAllPizzas = () => {
          store.commit("DELETE_ALL_PIZZAS_IN_CART")
        }
        


        return{
            cartItems,totalCount,totalSum,handleDeleteAllPizzas
        }
    }
}
</script>
